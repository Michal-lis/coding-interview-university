...
- [x] [Computer Architecture, Sixth Edition: A Quantitative Approach](https://www.amazon.com/dp/0128119055)
    - For a richer, more up-to-date (2017), but longer treatment

### Python

- [PROGRESS] [Data Structures and Algorithms in Python](https://www.amazon.com/Structures-Algorithms-Python-Michael-Goodrich/dp/1118290275/)
...
- ### Trees - Notes & Background
    ...
    - [X] [BFS(breadth-first search) and DFS(depth-first search)](https://www.youtube.com/watch?v=uWL6FJhq5fM)
        - BFS notes:
...
- I'll implement:
    ...
    - [X] DFS with adjacency matrix (recursive) - very very easy
    - [X] DFS with adjacency matrix (iterative with stack)
    - [X] BFS with adjacency list
    - [X] BFS with adjacency matrix - to return the shortest path you have to store in the que not the node itselft but the whole path to it
...
- ### Scheduling
    -[X] in an OS, how it works
    -[X] can be gleaned from Operating System videos
